    ...
    <>
      ...
      <section className="border-b border-[#d9bcc1] bg-[#ecdcdf] py-12 sm:py-24">
        <div className="container-page">
          ...
          <h1 className="font-display mt-4 max-w-2xl text-3xl font-bold tracking-tight text-[#2e3236] sm:text-5xl lg:text-[58px]">
            Your Work Deserves a Better Workstation.
          </h1>
          <p className="mt-5 max-w-xl text-base text-[#5c4448] sm:text-lg">
          ...
          <ImagePanel url={heroImageUrl} className="mt-8 h-[220px] border-white/40 sm:mt-14 sm:h-[280px] lg:h-[360px]" />
        </div>
      </section>
      ...
      <section className="bg-[#202326] py-12 sm:py-24">
        <div className="container-page">
          <h2 className="font-display text-2xl font-bold text-white sm:text-[28px]">
            Where Our Workstations Make a Difference
          </h2>
      ...
      <section className="border-t border-[#e0e4e7] py-12 sm:py-24">
        <div className="container-page grid gap-8 overflow-hidden rounded-lg border border-[#e0e4e7] sm:gap-12 lg:grid-cols-2 lg:gap-0">
          ...
          <div className="bg-white p-6 sm:p-10 lg:p-12">
            <h2 className="font-display text-2xl font-bold tracking-tight sm:text-[32px]">From Desk to Delivery.</h2>
