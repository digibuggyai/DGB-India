  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border bg-background/90 backdrop-blur">
      <div className="container-page flex h-18 items-center justify-between py-4">
        <Link href="/" className="flex items-center gap-2 text-lg font-semibold tracking-tight" onClick={close}>
          <span className="flex h-8 w-8 items-center justify-center rounded bg-accent font-mono text-sm text-accent-foreground">
            DB
          </span>
          {siteName}
        </Link>
